...
const PowerProfile PROFILE_NORMAL = {
    ...
    .lidarPower = 80.0f,           // 20 Hz LiDAR - rapid forward updates
...
const PowerProfile PROFILE_LOW_POWER = {
    ...
    .lidarPower = 20.0f,           // 5 Hz LiDAR - sparse forward awareness
...
const PowerProfile PROFILE_HIGH_STRESS = {
    ...
    .lidarPower = 150.0f,          // 30 Hz LiDAR - rapid threat updates
...
const PowerProfile PROFILE_EMERGENCY = {
    ...
    .lidarPower = 180.0f,          // 40 Hz LiDAR - detailed landing site mapping
